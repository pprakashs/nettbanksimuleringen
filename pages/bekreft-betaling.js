			...
			<section className="bg-white px-7 shadow-md py-10 pb-24">
				...
				<div className="border border-black-100">
					<div className="bg-[#E0E0E0] flex">
						<div className="w-3/5 text-xl font-anenirHeavy px-5 py-2">Betale fra</div>
						<div className="w-2/5 border-l border-black-100 text-xl font-anenirHeavy px-5 py-2">Betale til</div>
					</div>
					<div className="flex border-t border-black-100 bg-pink">
						<div className="w-3/5 p-5 py-12 text-xl">{transaction !== null && transaction.selectedAccountNumber}</div>
						<div className="w-2/5  p-5 py-12 border-l border-black-100 text-xl">{transaction !== null && transaction.transferAccountNumber}</div>
					</div>
				</div>

				<div className="border border-black-100 border-t-0">
					<div className="bg-[#E0E0E0] flex">
						<div className="w-1/2 text-xl font-anenirHeavy px-5 py-2">Mottakers navn</div>
						<div className="w-1/2 border-l border-black-100 text-xl font-anenirHeavy px-5 py-2">Eget notat</div>
					</div>
					<div className="flex border-t border-black-100 bg-pink">
						<div className="w-1/2 p-5 py-12 text-xl">{transaction !== null && transaction.navn}</div>
						<div className="w-1/2  p-5 py-12 border-l border-black-100 text-xl">{transaction !== null && transaction.notat}</div>
					</div>
				</div>
				...
				<div className="border border-black-100 border-t-0">
					...
					<div className="flex border-t border-black-100 bg-pink">
						<div className="w-4/12 text-xl px-5 py-12">{transaction !== null && getTodayDate()}</div>
						<div className="w-7/12 text-xl px-5 py-12 border-l border-black-100">{transaction !== null && transaction.kidNumber}</div>
						<div className="w-4/12 border-l border-black-100 text-xl px-5 py-12">{transaction !== null && numberFormat(transaction.amount)}</div>
					</div>
				</div>
