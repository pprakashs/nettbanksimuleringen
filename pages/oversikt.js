          ...
          <div className="mb-10 flex flex-col">
            ...
            <div className="ml-auto flex items-center">
              ...
              <div className="relative text-base lg:text-xl has-dropdown">
                <button
                  type="button"
                  className="selected-account focus:outline-none cursor-pointer px-3 py-[10px] pr-11 border border-secondary rounded-md lg:w-[600px] w-[500px] flex has-dropdown"
            ...
            <tbody>
              {selectedAccount.transaction.map((el, index) => (
                <tr className={`${index % 2 !== 0 ? 'bg-[#EFEFEF]' : null}`} key={index}>
                  ...
                  <td className="py-3 lg:px-5 px-3 border-l border-secondary text-right align-top text-primary">
